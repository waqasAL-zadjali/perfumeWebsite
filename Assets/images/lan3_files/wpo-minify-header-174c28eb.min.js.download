 ...
 */
(function($){"use strict";$(document).ready(function(){var el_html=$('html');var isLocalStorageNameSupported=function(){var testKey='test',storage=window.sessionStorage;try{storage.setItem(testKey,'1');storage.removeItem(testKey);return!0}catch(error){return!1}};$('#woovina-toolbar-open').click(function(){var _this=$(this);var parent=_this.closest('#woovina-toolbar');var contentWrap=$('#woovina-toolbar').find('.toolbar-content');var pluginUrl=contentWrap.attr('data-url');var hidebar=contentWrap.attr('data-hidebar');var isLoaded=contentWrap.attr('data-load');if(isLoaded!='loaded'){contentWrap.html('<span class="loading">Loading...</span>');$.ajax({method:"GET",url:"https://toolbar.woovina.net/woovina.php",data:{pluginUrl:pluginUrl,hidebar:hidebar}}).done(function(content){contentWrap.html(content);contentWrap.attr('data-load','loaded')})}
if(parent.hasClass('active')){parent.removeClass('active');el_html.removeClass('no-scroll')}else{parent.addClass('active');el_html.addClass('no-scroll')}
_this.toggleClass('active-open')});$('#woovina-toolbar .overlay').click(function(){$('#woovina-toolbar-open').trigger('click')});var hidebar=$.cookie("hidebar");if(hidebar=='hidebar'){$('#copyright').html('© Copyright 2023 WooVina - All Rights Reserved - Powered by WooVina Theme.');$('#woovina-copyright > a').removeAttr('href');$('#woovina-copyright > a').removeAttr('target')}})})(jQuery);
